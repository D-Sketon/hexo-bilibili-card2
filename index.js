...
hexo.extend.generator.register('bili_play', () => [{
  path: 'svg/play.svg',
  data: () => fs.createReadStream(path.resolve(__dirname, "./source", "play.svg"))
}
]);

hexo.extend.generator.register('bili_danmaku', () => [{
  path: 'svg/danmaku.svg',
  data: () => fs.createReadStream(path.resolve(__dirname, "./source", "danmaku.svg"))
}
]);

hexo.extend.generator.register('bili_up', () => [{
  path: 'svg/up.svg',
  data: () => fs.createReadStream(path.resolve(__dirname, "./source", "up.svg"))
}
]);

hexo.extend.tag.register("bilicard2", async (args) => {
